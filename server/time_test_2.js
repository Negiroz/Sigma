...
const endpoints = [
    '/dashboard/merit/leaderboard',
    '/dashboard/merit/agent/1/pacing',
    '/dashboard/merit/highlights',
    '/dashboard/merit/versus-standings',
    '/dashboard/data-entry/daily-merit',
    '/dashboard/data-entry/monthly-merit'
];
